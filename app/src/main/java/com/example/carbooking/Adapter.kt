...
class Adapter (private val appList: ArrayList<Model>):
    ...
    //emp_list_item is refer to layout named emp_ist_item
    ...
    //component that had layout emp_list_item
    //empName: edit text
    //empAge: edit text
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvCustCarModel.text = currentApp.custCarModel
    }
    ...
    class ViewHolder(itemView: View, clickListener: onItemClickListener) : RecyclerView.ViewHolder(itemView) {
        ...
        val tvCustCarModel : TextView = itemView.findViewById(R.id.tvCustCarModel)
