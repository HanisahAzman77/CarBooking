...
import com.google.firebase.database.FirebaseDatabase
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        carModel = findViewById<EditText>(R.id.carModel)


        //popup message when click button add record
        Toast.makeText(this, "Dear Customer, Please fill in the form", Toast.LENGTH_LONG).show()
        ...
        btnS.setOnClickListener{
            ...
            saveCustData(name.text.toString(),icNumber.text.toString(), phoneNum.text.toString(),
                monthlySalary.text.toString(), duration.text.toString(), carModel.text.toString())
    ...
    //n = name, ic = ic number, pn = phone number, ms = monthly salary, d = duration, cm = car model


    private fun saveCustData(n:String, ic:String, pn:String, ms:String, d:String, cm:String)
    {
        ...
        //input name and age
        val cm = Model(custId, n, ic, pn, ms, d, cm )
